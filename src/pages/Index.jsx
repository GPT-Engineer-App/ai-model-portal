      ...
      <main>
        <section className="py-20">
          <div className="container mx-auto text-center">
            <h2 className="text-5xl font-bold mb-6">Unleash the Power of AI</h2>
            <p className="text-xl mb-8">FREE+OPEN provides a free, open-source API and reverse proxy for AI models.</p>
            <a href="#" className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-8 rounded-full inline-flex items-center">
        ...
        <section className="py-20">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl mb-8">FREE+OPEN is completely open-source. Contribute and help shape the future of AI accessibility.</p>
